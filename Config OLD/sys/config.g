...
M201 X1300 Y1300 Z300:300:300 E1000		; Set Accel (mm^2/s)
...
M906 X1800 Y1800 Z1500 E1200  I25    ; Set motor currents (mA) and motor idle factor in per cent
...
; ***********************************
G31 P500 X-21.1 Y45.7 Z18.79 ; set Z probe trigger value, offset and trigger height.  Higher numbers makes nozzle closer to bed
; ***********************************
...
M143 H1 S280                        ; Set temperature limit for heater 6 to 280C
