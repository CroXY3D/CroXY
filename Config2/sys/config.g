...
M569 P2 S0                        ; Z Left Drive 2 goes backwards (z)	
M569 P3 S1                        ; Z Right Front Drive 3 goes forwards 
M569 P4 S0  	                  ; OLD X Front Drive 4 goes forwards F6 is blanking time, diff for every stepper to make idle noise less
...
M584 X0:9 Y1:5 Z2:4:8 E6 U9 V5 P3	; config U, V for splitting when homing, but only show P=3 axis in DWC
...
M208 X-125 U-125 Y-130 V-130 Z0 S1 ; set axis minima. setting xMin to -130 causes probe to jump out because nobody knows how magnets work
M208 X130 U130 Y128 V128 Z250 S0 ; set axis maxima

; Endstops
M574 X2 U2 Y2 V2 S1                  ; Endstops X at High End, Y at High End, S=1 - Active High (NC)

; ********** Z-Probe ****************
M558 P5 H8 F320 T12000 A1 S.01 ; set Z probe type to switch and the dive height + speeds.  Probe A (5) times

; ***********************************
G31 P500 X-41.48 Y46.08 Z19.34 ; set Z probe trigger value, offset and trigger height.  Higher numbers makes nozzle closer to bed
; ***********************************
...
M305 P1 X4 R4700 T100000 B4725 C7.06e-8 S"Volcano"; E3D V6 Semitec GT-104 thermistor cartridge
...
;// HE Fan
M106 P3 S255 L255 I0  F500 H1 T50 
;// PC Fan
M106 P4 S0 I0 F500 H-1 C"ExtruderFan" 		;  part cooling ,

; Tools
M563 P0 D0 H1 F4 S"Hemera"           ; Define tool 0, Drive 3 , E3 Heater (H4)  (duex5) Fan 3 (duex5 12v)
