...
M569 P2 S0                        ; OLD!   (NOT BURNED OUT) Z Left Drive 2 goes backwards (z)	
M569 P3 S1                        ; Z Left Drive 3 goes forwards 
M569 P4 S1  	                  ; Z Right Front Drive 4 goes forwards

; Duex5 Drives
M569 P5 S0			  ; Y Rear Drive 5 goes backwards
M569 P6 S1			  ; Extruder Drive 6 goes forwards		

M569 P7 S0		      ; Test Extruder drive 7 goes backwards

M569 P8 S1			  ; Z Right Rear Drive 8 goes forwards
M569 P9 S0			  ; X Rear Drive 9 goes backwards




M584 X0:9 Y1:5 Z3:4:8 E6:7 U9 V5 P3	; config U, V for splitting when homing, but only show P=3 axis in DWC


; ORIGINAL
M350 X16:16 U16 Y16:16 V16 Z16:16:16  I1			; 16 microstepping interpolation
M350 E16:16 I1					; 32 makes for prettiest		
M92 X160:160 U160 Y160:160 V160 Z1600:1600:1600 E414:703 	; Steps/mmm
...
; **************************************
M203 X24000:24000 U24000 Y24000:24000 V24000  Z1000:1000:1000 E3600:1800   ; Set maximum speeds (mm/min)  - keep in sync with macros/ZPostprint.g
;M201 X1966 U1966 Y966 V1966 Z300:300:300 E1000		; Set Accel (mm^2/s) ; Tuned 6 Jun 2020 via Kiss <TUNINGVAL>
M201 X3500 U3500 Y3500 V3500 Z300:300:300 E1000:100		; Set Accel (mm^2/s) ; Tuned 16 Aug 20 via PS Accel.  This is where the curves look best
...
M566 X566 U566 Y566 V566 Z25 E12000:1000 		; Set "Jerk" (mm/min) ; Tuned 6 Jun 2020 via Kiss <TUNINGVAL>

M906 X1500 U1500 Y1500 V1500 Z1500 E1000:200  I25    ; Set motor currents (mA) and motor idle factor in per cent
...
; Derpa
M308 S2 P"e5temp" Y"thermistor" R4700 T100000 B4725 C7.06e-8 A"derpa"
M950 H2 C"duex.e6heat" T2
M143 H2 S280                        ; Set temperature limit for heater 1 to 280C
M307 H2 A380.3 C181.9 D6.1 S1.00 V24.3 B0

M950 F2 C"fan0" Q500 	; don't use duex b/c fans are 12v there
M106 P2 S1 H2 T50
M563 P1 D1 H2 F2 S"derpa"  
G10 P1 R0 S0 
